...
export default function FloatingWhatsApp() {
  return (
    <a
      href={waLink("Hi Code Origin.ai! I'd like to know more about your services and the Code Pilot internship.")}
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Chat with us on WhatsApp"
      className="group fixed bottom-5 right-5 z-50 flex items-center gap-3 rounded-full bg-wa p-3.5 shadow-2xl shadow-wa/30 transition hover:scale-105 sm:bottom-7 sm:right-7"
    >
